...
class Matrix:
    ...
    #  !!!
    #  NOTE: In this class ,we must guarantee that items of each row have linear indexes.
    #  !!!
    ...
    def get_item_offset(self, row, column):
    ...
    def write_item_by_position(self, row, column, new_value):
        ...
        self.__v[self.__ptr[row] + column] = new_value

    def write_item_by_offset(self, offset, new_value):
    ...
    def get_item_by_position(self, row, column):
        ...
        return self.__v[self.__ptr[row] + column]
